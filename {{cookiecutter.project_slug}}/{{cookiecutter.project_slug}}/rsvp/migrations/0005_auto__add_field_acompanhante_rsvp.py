...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Acompanhante.rsvp'
        db.add_column(u'rsvp_acompanhante', 'rsvp',
                      self.gf('django.db.models.fields.CharField')(default=u'vazio', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Acompanhante.rsvp'
        db.delete_column(u'rsvp_acompanhante', 'rsvp')
    ...
    models = {
        ...
        u'rsvp.convidadorsvp': {
            ...
            'nome_completo': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'rsvp': ('django.db.models.fields.CharField', [], {'default': "u'vazio'", 'max_length': '16'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'xyqY6jS9P7Af'", 'max_length': '128', 'blank': 'True'})
        }
    }
