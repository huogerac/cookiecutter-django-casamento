...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConvidadoRSVP.slug'
        db.add_column(u'rsvp_convidadorsvp', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=u'nAYJCrQLVNUm', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConvidadoRSVP.slug'
        db.delete_column(u'rsvp_convidadorsvp', 'slug')
    ...
    models = {
        ...
        u'rsvp.convidadorsvp': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'AEmGpw7qMx30'", 'max_length': '128', 'blank': 'True'})
        }
    }
